...
##  The Golden Egg
  All said and done, we cannot overlook the fact that the revenue yielded by Urban cities is multiple times more than other city types. While we work towards providing better services to Suburban and Rural areas, it is crucial to ensure that the current services rendered to Urban areas are continued, if not improved, to keep the revenue flowing in.
